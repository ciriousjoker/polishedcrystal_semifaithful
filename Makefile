...
RGBASM_FLAGS += -DFAITHFUL_PKM_MOVES 
RGBASM_FLAGS += -DFAITHFUL_PKM_ABILITIES 
RGBASM_FLAGS += -DFAITHFUL_ITEMS 
RGBASM_FLAGS += -DFAITHFUL_TRAINER_PARTIES
RGBASM_FLAGS += -DFAITHFUL_TEXTS 
endif
